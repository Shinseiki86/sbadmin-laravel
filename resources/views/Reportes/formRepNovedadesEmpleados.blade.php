...
<div class="row">
	<div class="col-xs-6 col-sm-6">
		@include('widgets.forms.input', ['type'=>'date', 'column'=>6, 'name'=>'fchaDesde', 'label'=>'Fecha Creación Desde' ])
		@include('widgets.forms.input', ['type'=>'date', 'column'=>6, 'name'=>'fchaHasta', 'label'=>'Fecha Creación Hasta' ])
	</div>

	<div class="col-xs-6 col-sm-6">
		@include('widgets.forms.input', ['type'=>'select', 'column'=>6, 'name'=>'periodo', 'label'=>'Periodo de Nómina', 'ajax'=>['model'=>'PeriodoNomina','column'=>'PENO_DESCRIPCION']])
...
<div class="row">
	<div class="col-xs-6 col-sm-6">
		@include('widgets.forms.input', ['type'=>'select', 'column'=>6, 'name'=>'concepto', 'label'=>'Concepto de Nómina', 'ajax'=>['model'=>'Concepto','column'=>'CONC_DESCRIPCION']])
	</div>
